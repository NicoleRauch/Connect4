...
:li.:link reftype=hd refid=6000 .The Connect Four Contest:elink.
:esl.
...
:p.
:ul.
:li. Katharina :lm margin=25.for her patience, help and understanding.:lm margin=4.
:li. Olaf :lm margin=25.for his continuous complaints concerning the 
game&apos.s outward appearance. He also let himself down to record the 
"Insert" and "Game New" sounds with his "holy" Mac.:lm margin=4.
:li. Eberhard Mattes :lm margin=25.for developing EMX, a great tool. He also helped
us with a problem regarding the .INI file.:lm margin=4.
:li. Marc van Woerkom :lm margin=25.for developing the "Multimedia for EMX" 
libraries.:lm margin=4.
:li. Larry Salomon jr. :lm margin=25.for publishing the Electronic Developer&apos.s
Magazine. It gave us lots of background information about OS/2 programming.:lm margin=4.
:li. IBM :lm margin=25.one could say, without their fine operating system this
program would have been impossible to write.
:eul.
:lm margin=1.
:p.
...
FTP sites, as for example ftp.cdrom.com or in Germany at 
...
:li.It should be written in EMX-C and should be as bug-free as possible. 
...
this contest, please have a look at the files in contest.zip. There
you will find the Object files you need for compiling a little text-only
version of Connect Four which you can use for testing purposes, 
and some sample valuation functions. If you have any questions,
please contact us. Our addresses are listed in 
