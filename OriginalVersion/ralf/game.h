...
enum { inf = 10000,					/* infinitiv: return if board is won */
...
PUBLIC VALFUNC *ValFunc;			/* Board valuation function to be used when */
											/* the computer has to move */
...
PUBLIC VALFUNC RalfsValuation;

PUBLIC VALFUNC NicolesValuation;

PUBLIC VALFUNC NullValuation __attribute__ ((const));

PUBLIC VALFUNC RndValuation;
